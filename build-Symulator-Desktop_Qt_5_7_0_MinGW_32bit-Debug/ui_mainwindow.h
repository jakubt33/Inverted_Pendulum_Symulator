...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelTriesCounter->setGeometry(QRect(560, 20, 31, 20));
        numberTries = new QLCDNumber(centralWidget);
        numberTries->setObjectName(QStringLiteral("numberTries"));
        numberTries->setGeometry(QRect(509, 20, 51, 23));
        numberTries->setDigitCount(5);
        numberWins = new QLCDNumber(centralWidget);
        numberWins->setObjectName(QStringLiteral("numberWins"));
        numberWins->setGeometry(QRect(600, 20, 51, 23));
        numberWins->setDigitCount(5);
